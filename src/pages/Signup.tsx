...
export const Signup = () => {
  return (
    <div className="flex flex-col justify-center h-screen">
      <div className="flex flex-col xl:flex-row sm:w-[90%] md:w-[60%] xl:w-[80%] xl:min-w-[1200px] xl:max-w-[1200px] xl:min-h-[560px] xl:max-h-[560px] mx-auto gap-12 sm:h-[80%] md:h-[90%] xl:h-[90%]">
        ...
        <div className="bg-primary-secondary md:w-full xl:w-1/2 sm:hidden md:flex xl:flex justify-center items-center relative">
