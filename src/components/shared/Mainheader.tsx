  ...
  return (
    <header className="flex items-center justify-between px-6 py-4 bg-white border-b border-gray-200 mb-4">
      ...
      <div className="flex items-center gap-6">
       { user?.role_id === 8 &&<Button onClick={handleVisitFlexologist} className="bg-primary-base text-white hover:bg-primary-base/80 font-medium py-2 px-1 text-sm flex items-center gap-2">
